...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-background-light">
      {/* Top Navigation */}
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-slate-200 bg-white px-6 md:px-10 py-4">
        <div className="flex items-center gap-4 text-primary">
          ...
          <div>
            <h1 className="text-primary text-lg font-bold tracking-tight">Bus Pass Portal</h1>
